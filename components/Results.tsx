...
export default function Results({ 
  ...
  const handleShareFacebook = () => {
    ...
    const quote = encodeURIComponent(`I just scored ${wpm} WPM on Type Digital! 🎯\n\nCan you beat my typing speed? Test yourself now!`);
    ...
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: '#E8E4D9' }}>
      ...
      <div className="bg-white shadow-sm p-3 sm:p-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-2xl sm:text-3xl font-bold leading-tight mb-1" style={{ color: '#3D3D3D', fontFamily: 'var(--font-space-grotesk)' }}>
          ...
          <a 
            ...
            className="text-xs sm:text-sm hover:underline transition-all inline-block"
            style={{ color: '#6B6B6B' }}
          >
            by Digital Sheakh
          </a>
            ...
            <div className="mb-6">
              ...
              <div className="flex gap-2 justify-center">
                <button
                  ...
                  className="flex-1 py-3 px-4 rounded-lg font-semibold transition-all hover:opacity-90 active:scale-95 shadow-md flex items-center justify-center gap-2"
